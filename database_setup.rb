...
DATABASE.execute("CREATE TABLE IF NOT EXISTS assignments (id INTEGER PRIMARY KEY, date TEXT, name TEXT, description TEXT, blog_link_id INTEGER, github_link_id INTEGER, student_id INTEGER);")
